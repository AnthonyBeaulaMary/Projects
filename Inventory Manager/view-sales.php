...
<html lang="en">
	...
	<body>
		...
		<div class="header">
			...
			<h3 style = "color:black"> &nbsp &nbsp &nbsp SALES DETAILS</h3>
		...
		<div class="navbar">
			...
			<a href="export-sales.php">EXPORT</a>
			<a href="empty-sales.php">EMPTY</a>
			<a style = "background-color:green;" href="reg-sales.php?GetID=<?php echo $ProductID ?>">ADD</a>
		</div>
		...
		<div>
			...
			<table border = "1">
				...
				<tr>
					...
					<td><a style = "text-decoration:none" href="edit-sales.php?GetID=<?php echo $ProductID ?>"><font color = "blue">Edit</font></a></td>
					<td><a style = "text-decoration:none" href="delete-sales.php?Del=<?php echo $DateAndTime ?>"><font color = "RED">Delete</font></a></td>	
				</tr>
